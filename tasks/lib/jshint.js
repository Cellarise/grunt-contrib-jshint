 ...
 *
 * JB 18/05/2014 - Update jshint to have source files sent to reporters as a parameter to allow for reporters to report on passed files
 */
...
exports.init = function (grunt) {
    ...
    exports.selectReporter = function (options) {
        switch (true) {
            //bamboo reporter
            case options.reporter === 'bamboo-reporter':
                options.reporter = '../../tasks/lib/bamboo-reporter.js';
                break;
    ...
    exports.lint = function (files, options, done) {
        ...
        cliOptions.reporter = function (results, data) {
            ...
            for (file in files) {
                files[file] = reporterOutputDir ? path.relative(reporterOutputDir, files[file]) : files[file];
            }
            reporter(results, data, options, files);
